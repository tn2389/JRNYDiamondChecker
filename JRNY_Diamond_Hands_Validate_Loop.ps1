...
foreach($wallet in $AheadOfHerdPOAPList){
...
$Response = Invoke-RestMethod -Uri "https://api.etherscan.io/api?module=account&action=tokennfttx&contractaddress=0x0b4B2bA334f476C8F41bFe52A428D6891755554d&address=$wallet&page=1&offset=100&startblock=0&endblock=27025780&sort=asc&apikey=PWFKBXYI5KNDH6W76T6HS34W1N5XTR8QYQ"
...
if($Response.result[$n].to -eq $wallet){
...
Write-Host "There were $($holder) holders and $($flipper) flippers or people who have transferred to another wallet."
